...
const file_filesystem_filesystem_proto_rawDesc = "" +
	...
	"\rRemoveWatcher\x12 .filesystem.RemoveWatcherRequest\x1a!.filesystem.RemoveWatcherResponseB\x9b\x01\n" +
	"\x0ecom.filesystemB\x0fFilesystemProtoP\x01Z0github.com/0prodigy/OpenE2B/pkg/proto/filesystem\xa2\x02\x03FXX\xaa\x02\n" +
	"Filesystem\xca\x02\n" +
